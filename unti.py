...
class DataPreparation:
    ...
    @staticmethod    
    def import_data(input_length, target_distances, number_of_samples, top_required_position=200, dump_folder="data/sequences"):
        ...
        description = str(input_length) + "_" + str(target_distances) + "_" + str(number_of_samples) + "_" + str(top_required_position)  
        ...
        max_offset = time_delta.days - input_length - max(target_distances) - 1
    ...
    def import_train_test(input_length, target_distance,
     number_of_samples, top_required_position=200, sequence_dumps="data/sequences",
      hold_out_perc=80, splits_dumps="data/splits", processors=4, scale=False):
